                            ...
                            <div class="am-u-sm-12 ">
                                <form class="am-form am-form-horizontal" id="sgform">
                                    <div class="am-form-group">
                                        <label for="sc-cid" class=" am-form-label">商品分类</label>
                                        <div class="">
                                    ...
                                    <div class="am-form-group">
                                        <label for="glist" class=" am-form-label">商品列表</label>
                                        <div class="">
                                    ...
                                    <div class="am-form-group">
                                        <label for="money" class=" am-form-label">商品单价</label>
                                        <div class="">
                                    ...
                                    <div class="am-form-group">
                                        <label for="number" class=" am-form-label">购买数量</label>
                                        <div class="">
